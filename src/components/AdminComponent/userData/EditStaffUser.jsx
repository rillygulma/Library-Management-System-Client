...
const EditStaffUser = () => {
  ...
  useEffect(() => {
    const fetchUser = async () => {
      try {
        ...
        const response = await axios.get(`https://library-management-system-server-f0vl.onrender.com/api/admin/user/${id}`, {
          headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(`https://library-management-system-server-f0vl.onrender.com/api/admin/updateuser/${id}`, formData, {
        headers: {
          "Content-Type": "application/json",
          "Authorization": `Bearer ${accessToken}`
        }

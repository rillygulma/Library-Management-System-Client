...
const UserBorrowHistory = () => {
  ...
  useEffect(() => {
    const fetchCartData = async () => {
      setLoading(true);
      try {
        const response = await axios.get(`https://library-management-system-server-f0vl.onrender.com/api/users/${userId}/cartItems`, {
          headers: {
  ...
  const handleReturnBook = async () => {
    ...
    try {
      const response = await axios.post(
        `https://library-management-system-server-f0vl.onrender.com/api/users/${userId}/returnBook/${selectedBook.borrowedBookId._id}`,
        {
  ...
  const handleRenewBook = async () => {
    ...
    try {
      const response = await axios.post(
        `https://library-management-system-server-f0vl.onrender.com/api/users/${userId}/renewBook/${selectedBook.borrowedBookId._id}`,
        {
          returnDate: returnDate.toISOString(),
          role,
          fullName,
